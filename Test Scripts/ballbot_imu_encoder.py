...
def main():
    ...
    # ---- Wait for first valid feedback & set zero biases ----
    # Set angle zeros and encoder baselines AFTER valid data arrives
    theta_x_0, theta_y_0, theta_z_0 = msg.imu_angles_rpy
    enc_pos_1_start = msg.enc_ticks[0]
    enc_pos_2_start = msg.enc_ticks[1]
    enc_pos_3_start = msg.enc_ticks[2]
    print("IMU zero set to:", theta_x_0, theta_y_0, theta_z_0)
